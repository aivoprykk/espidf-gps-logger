...
typedef enum {
    ...
    SCREEN_MODE_BOOT = 0,
    SCREEN_MODE_SPEED_STATS_1,
    SCREEN_MODE_SPEED_STATS_2,
    SCREEN_MODE_SPEED_STATS_3,
    SCREEN_MODE_SPEED_STATS_4,
    SCREEN_MODE_SPEED_STATS_5,
    SCREEN_MODE_SPEED_STATS_6,
    SCREEN_MODE_SPEED_STATS_7,
    SCREEN_MODE_SPEED_STATS_8,
    SCREEN_MODE_SPEED_STATS_9,
    SCREEN_MODE_GPS_TROUBLE,
    SCREEN_MODE_GPS_INIT,
    SCREEN_MODE_GPS_READY,
    SCREEN_MODE_WIFI_START,
    SCREEN_MODE_WIFI_AP,
    SCREEN_MODE_WIFI_STATION,
    SCREEN_MODE_PUSH,
    SCREEN_MODE_GO_SLEEP,
    SCREEN_MODE_SLEEP,
